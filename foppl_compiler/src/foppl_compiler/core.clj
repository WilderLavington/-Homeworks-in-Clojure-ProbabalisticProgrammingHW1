(ns foppl_compiler.core
  (:require  ;[gorilla-plot.core :as plot]
               ...
               [anglican.runtime :refer [normal tanh exp cos sin log pow]]))
...
(defn -main
  ...
  ; (println "foppl code:	evaluated	at	x	=	0 " foppl-code)
  ; (println (autodiff foppl-code [0.0]))
  ...
  ; (println "foppl code:	evaluated	at	x=0,	y=10" foppl-code)
  ; (println (autodiff foppl-code [0.0 10.0]))
  ; (println "numerical check that we are good: ")
  ...
  ; (println "foppl code:	x=5.000001" foppl-code)
  ; (println (autodiff foppl-code [5.000001]))
  ; (println "numerical check that we are good: ")
  ; (println (numerical-approx (fn [x] (if (> x 5) (* x x) (+ x 18)))
  ;                             [5.000001] 0.000000001) )
  ; (println "==================================================================")
  ; (println "Homework 2: Problem 4: \n")
  ; (def foppl-code '(fn [x] (log x)) )
  ; (println "foppl code: evaluated at	x=0.1" foppl-code)
  ; (println (autodiff foppl-code [0.1]))
  ; (println "numerical check that we are good: ")
  ...
  ;                                                 (* 2 (* sigma sigma))))
  ;                                      (* (- 0 (/ 1 2)) (log (* 2 (* 3.141592653589793 (* sigma sigma))))))) )
  ; (println "foppl code:	evaluated	at	x=10,	mu=0,	sigma=2" foppl-code)
  ; (println (autodiff foppl-code [10.0 0.0 2.0]))
  ; (println "numerical check that we are good: ")
  ; (println (numerical-approx (fn [x mu sigma] (+ (- 0 (/ (* (- x mu) (- x mu))
  ;                                                 (* 2 (* sigma sigma))))
  ;                                      (* (- 0 (/ 1 2)) (log (* 2 (* 3.141592653589793 (* sigma sigma)))))))
  ;                             [10.0 0.0 2.0] 0.00001) )
  ;
  ; (println "==================================================================")
  ...
  ; (println (autodiff foppl-code [10.0 0.0 2.0]))
  ; (println "numerical check that we are good: ")
  ; (println (numerical-approx (fn [x mu sigma] (normpdf x mu sigma))
  ;                             [10.0 0.0 2.0] 0.00001) )
  ; (println (normpdf 10.0 0.0 2.0))
  ; (println "==================================================================")
  ...
  ;                   (normpdf x3 -4 10))) )
  ; (println "foppl code: " foppl-code)
  ; (println (autodiff foppl-code [2.0 7.1 5.0]))
  ; (println "numerical check that we are good: ")
  ...
  ;                                 (normpdf x2 10 1)))
  ;                           (normpdf x3 -4 10)))
  ;                             [2.0 7.1 5.0] 0.0000001) )
  ; (println (+ (+ (normpdf 2.0 2 5)
  ;                               (if (> 7.1 7)
  ;                                 (normpdf 7.1 0 1)
  ;                                 (normpdf 7.1 10 1)))
  ;                           (normpdf  5.0 -4 10)))
