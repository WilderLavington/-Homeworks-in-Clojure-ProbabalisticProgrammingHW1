...
(defn -main
  ...
  (def general-ast (fn-create-ast (fn-function-parse (str foppl-code ))))
  (def expression (get-expression general-ast))
  (def forward-graph (function-logic-builder (get expression :forward-graph) {"x" 1.0} "root"))
  ; (println "==================================================================")
  ; (println "graphical representation: ")
  ; (print-graph-forward-evals (reverse-mode-auto-diff forward-graph 1 0))
  (println "==================================================================")
  (println "calculate gradient: ")
  (println (calculate-gradient (reverse-mode-auto-diff forward-graph 1 0) {}))
  (println "==================================================================")
  ...
  (def general-ast (fn-create-ast (fn-function-parse (str foppl-code ))))
  (def expression (get-expression general-ast))
  (def forward-graph (function-logic-builder (get expression :forward-graph) {"x" 1.0 "y" 10.0} "root"))
  ; (println "==================================================================")
  ; (println "graphical representation: ")
  ; (print-graph-forward-evals (reverse-mode-auto-diff forward-graph 1 0))
  (println "==================================================================")
  ...
  (def general-ast (fn-create-ast (fn-function-parse (str foppl-code ))))
  (def expression (get-expression general-ast))
  (def forward-graph (function-logic-builder (get expression :forward-graph) {"x" 3.0} "root"))
  ; (println "==================================================================")
  ; (println "graphical representation: ")
  ; (print-graph-forward-evals (reverse-mode-auto-diff forward-graph 1 0))
  (println "==================================================================")
  ...
  (def general-ast (fn-create-ast (fn-function-parse (str foppl-code ))))
  (def expression (get-expression general-ast))
  (def forward-graph (function-logic-builder (get expression :forward-graph) {"x" 10.0} "root"))
  ; (println "==================================================================")
  ; (println "graphical representation: ")
  ; (print-graph-forward-evals (reverse-mode-auto-diff forward-graph 1 0))
  (println "==================================================================")
  ...
  (def general-ast (fn-create-ast (fn-function-parse (str foppl-code ))))
  (def expression (get-expression general-ast))
  (def forward-graph (function-logic-builder (get expression :forward-graph) {"x" 0.5 "mu" 0.0 "sigma" 1.2} "root"))
  ; (println "==================================================================")
  ; (println "graphical representation: ")
  ; (print-graph-forward-evals (reverse-mode-auto-diff forward-graph 1 0))
  (println "==================================================================")
  ...
  (def general-ast (fn-create-ast (fn-function-parse (str foppl-code ))))
  (def expression (get-expression general-ast))
  (def forward-graph (function-logic-builder (get expression :forward-graph) {"x" 1.0 "mu" 0.1 "sigma" 2.1} "root"))
  ; (println "==================================================================")
  ; (println "graphical representation: ")
  ; (print-graph-forward-evals (reverse-mode-auto-diff forward-graph 1 0))
  (println "==================================================================")
  ...
  (def foppl-code '( (fn [x y z] (+ (+ (normpdf x 2 5)
                        (if (> y 7)
                          (normpdf y 0 1)
                          (normpdf y 10 1)))
                    (normpdf z 4 10))) ))
  ...
  (def general-ast (fn-create-ast (fn-function-parse (str foppl-code ))))
  (def expression (get-expression general-ast))
  (def forward-graph (function-logic-builder (get expression :forward-graph) {"x" 1.4 "y" 0.0 "z" 1.3} "root"))
  ; (println "==================================================================")
  ; (println "graphical representation: ")
  ; (print-graph-forward-evals (reverse-mode-auto-diff forward-graph 1 0))
  (println "==================================================================")
  ...
  (println "==================================================================")
  (println "numerical check that we are good: ")
  (println (numerical-approx (fn [x y z] (+ (+ (normpdf x 2 5) (normpdf y 10 1)
                                  (if (> y 7)
                                    (normpdf y 0 1)
                                    (normpdf y 10 1)))
                              (normpdf z 4 10)))
                              [1.4 0.0 1.3] 0.0000001) )
  (println "==================================================================")
